"""
dlg_ska_jones component module.

This is the module of dlg_ska_jones containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/dlg_ska_jones.MyData/String/readonly/
